...
namespace My_Second_Umbraco_7_Site.Helpers
{
    //Ref: https://codeshare.co.uk/blog/how-to-search-by-document-type-and-property-in-umbraco/#SearchHelper
    ...
    public class SearchHelper
    {
        ...
        public Examine.ISearchResults SearchUsingExamine(string[] documentTypes, List<SearchGroup> searchGroups)
        {
            ...
            if (documentTypes != null && documentTypes.Length > 0)
            {
                ...
                //queryNodes = searchCriteria.GroupedOr(new string[] { _docTypeAliasFieldName }, documentTypes);
            }
